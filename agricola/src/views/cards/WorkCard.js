...
import { workCardDetails } from "@/components/details/WorkCardDetails";
...
const WorkCard = ({ index, cardNumber, isTrigger, onClick }) => {
  // 카드가 클릭된 상태
  ...
  const imagePath = isClicked
    ? null
    : `../image/WorkCard/work${cardNumber}.png`;
